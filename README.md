...
![Miniconda](https://img.shields.io/badge/Miniconda-EFEFEF?logo=Miniconda&logoColor=97C900&style=plastic)
...
![Flake8](https://img.shields.io/badge/Flake8-AFAEB3?logo=Flake8&logoColor=009B94&style=plastic)
![Валидатор W3C](https://img.shields.io/badge/Валидатор%20W3C-8B8CC9?logo=Валидатор%20W3C&style=plastic)
...
![Perfect Pixel](https://img.shields.io/badge/Perfect%20Pixel-FFED00?logo=Perfect%20Pixel&style=plastic)
...
- **Functional Testing** - проверка соответствия функционала требованиям
- **Integration Testing** - тестирование взаимодействия компонентов системы
- **UI/UX Testing** - проверка пользовательского интерфейса и удобства использования
- **Security Testing** - тестирование на уязвимости и защищенность
- **Localization Testing** - проверка адаптации под разные языки и регионы
- **Acceptance Testing** - приемочное тестирование перед сдачей продукта
- **Cross-browser Testing** - проверка совместимости в разных браузерах
- **Regression Testing** - повторное тестирование после изменений
- **Adaptive Testing** - тестирование адаптивности на разных устройствах
- **Pixel-perfect Testing** - проверка соответствия макетам
- **Test Design** - разработка тестовых сценариев и случаев
- **Requirements Analysis** - анализ и верификация требований
...
![SQL](https://img.shields.io/badge/SQL-E8202A?logo=mysql&logoColor=white&style=plastic)
![Git](https://img.shields.io/badge/Git-2EA6C3?logo=Git&logoColor=red&style=plastic)
![Jira](https://img.shields.io/badge/Jira-D98CD3?logo=jira&logoColor=1085C9&style=plastic)
![TestRail](https://img.shields.io/badge/TestRail-FDCA01?logo=TestRail&logoColor=009B94&style=plastic)
